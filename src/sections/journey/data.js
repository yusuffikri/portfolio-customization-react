...
const data = [
  { id: 1, icon: <GiGraduateCap />, title: "State Polytechnic of Jember", desc: "I'm a Frontend Web Developer with a Assosiate degree in Computer Engineering at State Polytechnic of Jember from 2019 until 2022." },
