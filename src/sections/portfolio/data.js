...
const data = [
  {
    ...
    category: "frontend",
    image: Image1,
    title: "Personal Portfolio Vol.1",
    desc: "Create a Personal Portfolio for the first time, using HTML, CSS and a little Javascript.",
  ...
  },
  {
    ...
    desc: "Create a simple Starbuck Coffee Landing Page with 3 drinks menu's using HTML, CSS and Javascript",
  ...
  },
  {
    ...
    image: Image5,
    title: "Tic Tac Toes",
    desc: "Create a simple Tic Tac Toe Games for my mini project learning, using HTML, CSS, and Javascript",
  ...
  },
  {
    ...
    category: "frontend",
    image: Image6,
    title: "Personal Portfolio Vol.3",
    desc: "Create a simple Personal Porfolio with Theme Customization for my personal use using React JS",
